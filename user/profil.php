                ...
                <div class="single-cards-item">
                    <div class="single-product-image">
                        <a href="#">
                            ...
                            <img src="../assets/img/product/prof-bg.jpg" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-product-text">
                        ...
                        <h5>USER</h5>
                        <p class="ctn-cards"> Halo, perkenalkan saya <?php echo $s['user_nama']; ?></p>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                if(isset($_GET['alert'])){
                    if($_GET['alert'] == "sukses"){
                        echo "<div class='alert alert-success'>User anda berhasil diganti!</div>";
                    }
                }
                ?>
