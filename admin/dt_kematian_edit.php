                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Edit Data Kematian</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Edit Data Kematian</h3>
                </div>
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id" value="<?php echo $d['id_sementara']; ?>">
                                <input type="text" class="form-control" name="jenis_kelamin" required="required" value="<?php echo $d['jenis_kelamin']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id" value="<?php echo $d['id_sementara']; ?>">
                                <input type="date" class="form-control" name="tgl_kematian" required="required" value="<?php echo $d['tgl_kematian']; ?>">
                            </div>

                            <div class="form-group">
                                <label>Jam</label>
                                <input type="hidden" name="id" value="<?php echo $d['id_sementara']; ?>">
                                <input type="time" class="form-control" name="jam" required="required" value="<?php echo $d['jam']; ?>">
                            </div>
