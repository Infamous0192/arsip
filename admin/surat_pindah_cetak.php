...
<head>
    <title>Laporan Surat Pindah</title>
</head>
...
<body>
    ...
    <h3 style="text-align: center;">
        Laporan Surat Pindah <?= isset($_GET['bulan']) ? getMonthName((int)$_GET['bulan']) : '' ?> <?= isset($_GET['tahun']) ? $_GET['tahun'] : '' ?>
    </h3>
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <table border="1" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        $sql .= " ORDER BY id_surat_pindah DESC";

                        $surat_pindah = mysqli_query($koneksi, $sql);
                        while ($row = mysqli_fetch_array($surat_pindah)) {
                        ?>
                            <tr>
                                <td><?= ++$no; ?></td>
