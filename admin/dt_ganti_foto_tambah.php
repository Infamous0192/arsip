                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Tambah Data Ganti Foto</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Tambah Data Ganti Foto</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form method="post" action="dt_ganti_foto_aksi.php" enctype="multipart/form-data">
