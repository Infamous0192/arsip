                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Tambah Data Pengaduan</h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <div class="panel panel">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Tambah Data Pengaduan</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form method="post" action="pengaduan_aksi.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kategori_pengaduan" required="required">
                        </div>
