...
<head>
    ...
    <title>PETUGAS - Arsip Digital</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="dt_kematian.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Surat Kematian</span></a>
                        </li>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    if($profil['petugas_foto'] == ""){ 
                                                      ?>
                                                      <img src="../gambar/sistem/default.png" style="width: 20px;height: 20px">
                                                  <?php }else{ ?>
