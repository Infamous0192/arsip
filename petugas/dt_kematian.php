...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="pull-right">
                <a href="dt_kematian_tambah.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            </div>
            <br>
            <br>
            <br>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="modal fade" id="exampleModal_<?php echo $p['id_sementara']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="btn-group">
                                        <a href="dt_kematian_edit.php?id=<?php echo $p['id_sementara']; ?>" class="btn btn-default"><i class="fa fa-check"></i></a>
                                        <a href="dt_kematian_detail.php?id=<?php echo $p['id_sementara']; ?>" class="btn btn-default"><i class="fa fa-eye"></i></a>
